...
namespace BedrockLauncher.Pages.FetchLatestVersion
{
    ...
    {
        public FetchLatestVersionPagesSwitcher fetchLatestVersionPageSwitcher = new FetchLatestVersionPagesSwitcher();
        ...
        {
            fetchLatestVersionPageSwitcher.Init(this);
        }
    }

    public partial class FetchLatestVersionPagesSwitcher
    {
        public static FetchLatestVersionPage fetchLatestVersionsPage;
        ...
        public void Init(FetchLatestVersionPage page)
        {
            fetchLatestVersionsPage = page;
        }
