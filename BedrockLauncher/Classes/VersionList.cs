...
namespace BedrockLauncher.Classes
{
    public class VersionList : ObservableCollection<Version>
    {
        ...
        public VersionList(string cacheFile, Interfaces.ICommonVersionCommands commands)
        {
        ...
        private void ParseList(JArray data)
        {
            ...
            foreach (JArray o in data.AsEnumerable().Reverse())
            {
                Add(new Version(o[1].Value<string>(), o[0].Value<string>(), o[2].Value<int>() == 1, _commands));
            }
        }
