...
- Abide to the [code of conduct](./docs/CODE_OF_CONDUCT.md)
...
## Prerequisites
Make sure you meet both the [hardware prerequisites](./docs/HARDWARE_PREREQUISITES.md) and [software prerequisites](./docs/SOFTWARE_PREREQUISITES.md) to avoid introducing random environmental variables.
